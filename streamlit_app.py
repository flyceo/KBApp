...
st.write("**" + str(len(dff.index)) + """** Datensätze gefunden.  Datenquelle: Kraftfahrt-Bundesamt, Bestand nach Herstellern und Typen (FZ 6), Abrufdatum; Datenlizenz by-2-0; eigene eigene
Darstellung""")
